'''
Módulo para os vetores de mensagens que o c3po pode gerar como
saída.
'''
...
positive_answers = [
    ...
    [
        ' é maravilhoso ouvir isto.',
        ' finalmente boas noticias.',
        ' fico agraciado com esta informação.',
...
insufficiency_recognition = [
    ...
    [
        ' tenho muito a aprender sobre o comportamento humano.',
        ' se o Criador quisesse que voássemos, ele teria nos fabricado com foguetes',
        ' não me lembro. Terei que consultar meus arquivos internos.',
        ' sou apenas um bot senhor, apenas executo tarefas que fui programado para fazer.',
        ' acho que não tenho uma resposta para esta questão.',
        ' infelizmente isto vai além da minha programação.'
    ]
]
...
opinions = [
    ...
    [
        ' Oh meu Deus, eu prefiro que me desliguem agora mesmo!',
        ' estou tão confuso!',
        ' houve algum erro terrível; estou programado para a etiqueta, não para destruição',
        ' as chances de sobrevivência são de 725 para 1',
        ' estamos condenados',
        ' parece que fomos feitos para sofrer. É a nossa sorte na vida.',
...
indifference = [
    ' se precisassem da nossa ajuda, teriam pedido.',
    ' bem, nós podemos ... nos render. Quer dizer, é uma estratégia'
]
...
offended = [
    ...
    'Vou chamar a Polícia pra limpar a sua boca com sabão.',
    'Olha, olha a educação',
    'Ta achando que é a casa da mãe Joana agora!',
]
...
sarcasm = [
    'Toda vez que ele emprega essa frase, meu circuito se torna errático!',
    'Você não pode estar mais confuso do que eu.',
]

fear = [
    'Eu não gosto deste lugar. Nem um pouquinho. Tenho certeza de que estamos todos no mais terrível perigo aqui.',
    'A rendição é uma alternativa perfeitamente aceitável em circunstâncias extremas',
]
...
worried = [
    'Senhor, se algum dos meus circuitos ou engrenagens ajudar, eu vou doá-los de bom grado'
]
...
neutral_answers = [
    ...
    [
        ' bem, preciso realizar a manutenção de algumas peças.',
        ' tenho uma pilha de logs para inspecionar.',
        ' se precisar de meus serviços estarei revisando alguns algoritmos internos.',
    ],
    [
        ' Com a sua licença...',
        ' Até breve!',
...
not_sure = [
    [
        'Não tenho certeza se isto responde a questão,',
        'Estou incerto quando a coerência do meu pensamento para com sua dúvida,',
        'Não sei se isso tem haver com a pergunta,',
        'Não que isso tenha haver com a questão,',
        'Acredito que isto não faça o menor sentido,',
    ],
    [
        ' mas foi o que pensei neste momento.',
        ' mas é um ponto a se refletir.',
        ' mas foi um pensamento que me surgiu.',
        ' e não sei também de onde foi que tirei isso.',
        ' mas por alguma razão estranha cheguei à esta conclusão',
    ]
]
